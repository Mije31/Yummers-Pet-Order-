...
<body >
  ...
  <header>
    ...
    <div class="user-actions">
      <a href="login.php" class="user-action">
     ...
     <div class="sidebar" id="sidebar">
      ...
      <nav class="sidebarnav" >
        <ul>
          ...
          <li><a href="products.php"><span class="icon">Products A-Z</span></a></li>
      ...
      <div class="sidefooter" id="login">
        <a href="home.php"><span class="icons" id="login">Login</span></a>
  ...
  <div class="promo-banner">
    <div class="promo-item">
      ...
      <a href="#" class="promo-link">Join Pets Club</a>
    </div>
    <div class="promo-item">
      <span class="free-text">Free</span>
      <a href="#" class="promo-link">Click & Collect</a>
      <span class="promo-text">in as little as 1 hour</span>
    </div>
    <div class="promo-item">
      <span class="free-text">Free</span>
      <a href="#" class="promo-link">standard delivery</a> 
  ...
  <section class="hero"> 
    ...
    <div class="hero-content">
      ...
      <p class="hero-subtitle">Subscribe and save 10% when you Click & Collect or 5% on deliveries.</p>
  ...
  <section class="shop-section">
    ...
    <div class="pet-categories" id="my-pets">
      ...
      <div class="sign-in-section">
        <h3 class="sign-in-title"><a href="#" class="link">Sign in</a> for a personalised experience.</h3>
        <p class="sign-in-subtitle">Don't have an account? <a href="#" class="link">Join today</a></p>
  ...
  <section class="pets-club">
    <div class="pets-club-left">
        ...
        <div class="club-buttons">
            <a href="#" class="club-primary-btn">Sign up for tailored offers</a>
            <a href="#" class="club-secondary-btn">View top offers</a>
        </div>
...
<section class="featured-section">
  ...
  <div class="featured-items">
    ...
    <div class="featured-item">
      <span class="featured-label">New</span>
      <div class="featured-image">
        <img src="sal&sweetpotato.jpg" alt="">
        <a href="product.php" class="shop-btn">Shop now</a>
      </div>
    </div>
    <div class="featured-item">
